...
fault class. The contribution is the auditable contract and its failure boundaries, not a claim of
physical rollout improvement.
...
and add contact-rich replay. Until then, the paper makes no famous-benchmark inflation,
simulator-independent physics, or mature-standard claim.
