...
| DOC.007 | controlled results exist | True | error | docs/experiments/results.json (147864 bytes) |
| DOC.008 | public citation metadata exists | True | error | CITATION.cff (432 bytes) |
| DOC.009 | CI workflow exists | True | error | .github/workflows/ci.yml (1196 bytes) |
