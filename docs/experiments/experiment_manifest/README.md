...
| `contact_rich_cross_simulator_replay` | contact_rich_cross_simulator_replay_complete | content_addressed_primitive_world_protocol@5f6e3e853cb6 | 22.75 | 837.4 | `docs/experiments/contact_rich_replay/contact_rich_replay_report.json` |
