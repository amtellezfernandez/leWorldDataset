...
tested same-trace MuJoCo and Genesis replay adapters; Isaac has an emitted but untested adapter
mapping; SAPIEN remains an adapter-required target. External collaboration is Not defined yet. The
claim is adapter compliance, not simulator-independent physics.
