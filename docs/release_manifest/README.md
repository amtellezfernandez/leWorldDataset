...
| `WorldEpisode-supplement.zip` | public_evidence | exact | `63e7097a10a549ac` |
...
| `paper/arxiv/sections/introduction.tex` | public_evidence | exact | `d6322255485d8f77` |
| `paper/arxiv/sections/requirements.tex` | public_evidence | exact | `8e18521d823cdf15` |
| `paper/arxiv/sections/architecture.tex` | public_evidence | exact | `2b0ffe7c9ae2de72` |
| `paper/arxiv/sections/evaluation.tex` | public_evidence | exact | `c6bb6443858383b9` |
| `paper/arxiv/sections/discussion.tex` | public_evidence | exact | `2f46adbfe92f0e8b` |
| `paper/arxiv/sections/limitations.tex` | public_evidence | exact | `bf558d878c8fbee5` |
| `paper/arxiv/sections/conclusion.tex` | public_evidence | exact | `bd1155644e659a8e` |
| `paper/arxiv/sections/appendix.tex` | public_evidence | exact | `58118ab75154eb64` |
...
| `docs/experiments/RESULTS.md` | public_evidence | normalized | `b8f7cf3959f41aa7` |
| `docs/experiments/results.json` | public_evidence | normalized | `0c0c3318140b668b` |
...
| `docs/experiments/paper_claim_audit/paper_claim_audit_report.json` | public_evidence | exact | `77a8a5278d10536b` |
...
| `docs/experiments/open_reproduction_gates/open_reproduction_gates.json` | public_evidence | exact | `64b533cf64bfeebb` |
...
| `docs/experiments/lerobot_policy_full_training/README.md` | public_evidence | exact | `d53f5b389fee4e79` |
| `docs/experiments/lerobot_policy_full_training/protocol.json` | public_evidence | exact | `52b0d92c7104c839` |
| `docs/experiments/lerobot_policy_full_training/jobs.json` | public_evidence | exact | `bac0aea58bf79e95` |
| `docs/experiments/lerobot_policy_full_training/evaluation_reference.json` | public_evidence | exact | `2ab28e2a3c8f550f` |
| `docs/experiments/lerobot_policy_full_training/run_jobs.sh` | public_evidence | exact | `d954043e759a9cb7` |
| `docs/experiments/experiment_manifest/README.md` | public_evidence | exact | `a4c1505804734a52` |
| `docs/experiments/experiment_manifest/experiment_manifest.json` | public_evidence | exact | `09e8fe2dd4e1d308` |
...
| `docs/anonymous_supplement/README.md` | public_evidence | exact | `9bfc337646c58b15` |
| `docs/anonymous_supplement/supplement_report.json` | public_evidence | exact | `416626a5abf8b014` |
...
| `docs/experiments/neurips_submission/submission_format_report.json` | public_evidence | exact | `ac0cd685c728cd67` |
...
| `docs/experiments/contact_rich_replay/protocol.json` | public_evidence | exact | `5f6e3e853cb62191` |
| `docs/experiments/contact_rich_replay/README.md` | public_evidence | exact | `db0e4d7e4687c757` |
| `docs/experiments/contact_rich_replay/contact_rich_replay_report.json` | public_evidence | exact | `f73b7856e892b3cd` |
| `docs/experiments/contact_rich_replay/mujoco_runtime_report.json` | public_evidence | exact | `e9caa5a159812c7f` |
| `docs/experiments/contact_rich_replay/genesis_runtime_report.json` | public_evidence | exact | `875985e3728adbd1` |
| `docs/experiments/huggingface_recovery/recovery_verification.json` | public_evidence | exact | `5a716b5d5f4caedc` |
| `docs/experiments/meta_simulator_contract/adapter_contract_report.json` | public_evidence | exact | `f1bd79e4953dace5` |
...
| `docs/reviewer-concern-matrix.md` | public_evidence | exact | `e0f171507f24a8ba` |
| `docs/reference-release.md` | public_evidence | exact | `abcaddf9e1368a46` |
| `docs/huggingface-recovery.md` | public_evidence | exact | `34231004faf98112` |
| `docs/huggingface-recovery.json` | public_evidence | exact | `8becb377f9574488` |
...
| `Makefile` | release_script | exact | `6a19fd53d50e8d8d` |
| `tools/run_experiments.py` | release_script | exact | `d7a838e8a03b29f3` |
| `tools/open_reproduction_gates.py` | release_script | exact | `3875d4b4b215f320` |
| `tools/paper_claim_audit.py` | release_script | exact | `50af447f3641950e` |
| `tools/experiment_statistics.py` | release_script | exact | `61aa84c935c69e60` |
| `tools/experiment_manifest.py` | release_script | exact | `e783f52557f957f2` |
...
| `tools/contact_rich_cross_sim_replay.py` | release_script | exact | `f259fe72aa5035f9` |
...
| `tools/lerobot_policy_full_training.py` | release_script | exact | `4c6ae6963ac51c41` |
...
| `tools/release_manifest.py` | release_script | exact | `c6882fbd64490391` |
| `tools/submission_packet.py` | release_script | exact | `fdb2811ee5b1b125` |
| `tools/release_readiness.py` | release_script | exact | `2adffeaebbde3fbf` |
